import{a3 as B,Z as d,_ as u,a4 as v,$ as l,a0 as i,a1 as s,a2 as n,a5 as a,D as c}from"./framework-61fc4e0a.js";const m={},b=s("p",null,"Пусть файл Markdown поддерживает playground vue на вашем сайте VuePress.",-1),y=s("h2",{id:"конфиг",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#конфиг","aria-hidden":"true"},"#"),n(" Конфиг")],-1),A=s("div",{class:"language-typescript line-numbers-mode","data-ext":"ts"},[s("pre",{class:"shiki one-dark-pro",style:{"background-color":"#282c34"},tabindex:"0"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#7F848E","font-style":"italic"}},"// .vuepress/config.ts")]),n(`
...
`),s("span",{class:"line"},[s("span",{style:{color:"#ABB2BF"}},"  }),")]),n(`
`),s("span",{class:"line"},[s("span",{style:{color:"#ABB2BF"}},"};")]),n(`
`),s("span",{class:"line"})])]),s("div",{class:"highlight-lines"},[s("br"),s("br"),s("br"),s("br"),s("br"),s("br"),s("br"),s("br"),s("br"),s("div",{class:"highlight-line"}," "),s("br"),s("br"),s("br")]),s("div",{class:"line-numbers","aria-hidden":"true"},[s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"}),s("div",{class:"line-number"})])],-1),g=a('<h2 id="использование" tabindex="-1"><a class="header-anchor" href="#использование" aria-hidden="true">#</a> Использование</h2><p>Чтобы использовать playground vue, вы должны использовать контейнер с именем <code>vue-playground</code>.</p><p>В нем вы можете использовать 3 директивы:</p><ul><li><code>@file FileName</code>, затем блок кода для добавления файлов</li><li><code>@import</code>, затем блок json для настройки &quot;import map&quot;</li><li><code>@setting</code>, затем блок json для настройки параметров</li></ul><p>Вы можете увидеть демо ниже, чтобы увидеть больше деталей.</p><h2 id="демо" tabindex="-1"><a class="header-anchor" href="#демо" aria-hidden="true">#</a> Демо</h2>',6),h=a(`<details class="hint-container details"><summary>Code</summary><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="shiki one-dark-pro" style="background-color:#282c34;" tabindex="0"><code><span class="line"><span style="color:#ABB2BF;">::: vue-playground Vue Playground</span></span>
